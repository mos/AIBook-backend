...
class SmsDemo
{
     ...
     * @return stdClass
     */
    public static function sendSms( $phone, $verNum) {
        ...
        $request->setSignName(ALI_setSignName);

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode(ALI_setTemplateCode);
    ...
    public static function querySendDetails() {
        ...
        // 必填，短信接收号码
        $request->setPhoneNumber("18342271820");

        // 必填，短信发送日期，格式Ymd，支持近30天记录查询
        $request->setSendDate("20180510");
